...
public class production {
  ...
  protected String make_declaration(
				    ...
				    int     offset)
    {
      ...
      if (emit.lr_values())
        ret = "\t\tint " + labelname + "left = (( org.open.scad.parser.runtime.Symbol)" +
	  emit.pre("stack") + ".elementAt(" + emit.pre("top") + 
	  "-" + offset + ")).left;\n" +
	  "\t\tint " + labelname + "right = (( org.open.scad.parser.runtime.Symbol)" +
	  emit.pre("stack") + ".elementAt(" + emit.pre("top") +
	  "-" + offset + ")).right;\n";
      else ret = "";
	...
	return ret + "\t\t" + stack_type + " " + labelname + " = (" + stack_type + 
	  ")((" + " org.open.scad.parser.runtime.Symbol) " + emit.pre("stack") + ".elementAt(" + emit.pre("top")
	  + "-" + offset + ")).value;\n";
