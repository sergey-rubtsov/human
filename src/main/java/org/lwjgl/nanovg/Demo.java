...
//res/org/lwjgl/demo/entypo.ttf
        final ByteBuffer entypo           = loadResource("ui/entypo.ttf", 40 * 1024);
        final ByteBuffer RobotoRegular    = loadResource("ui/Roboto-Regular.ttf", 150 * 1024);
        final ByteBuffer RobotoBold       = loadResource("ui/Roboto-Bold.ttf", 150 * 1024);
        final ByteBuffer NotoEmojiRegular = loadResource("ui/NotoEmoji-Regular.ttf", 450 * 1024);
    ...
    static int loadDemoData(long vg, DemoData data) {
        ...
        for (int i = 0; i < 12; i++) {
            String     file = "ui/images/image" + (i + 1) + ".jpg";
