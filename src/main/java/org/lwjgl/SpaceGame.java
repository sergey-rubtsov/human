...
public class SpaceGame {
    ...
    private void createShip() throws IOException {
        ...
        ship = loader.loadMesh("ui/game/ship.obj.zip");
    ...
    private void createAsteroid() throws IOException {
        WavefrontMeshLoader loader = new WavefrontMeshLoader();
        asteroid = loader.loadMesh("ui/game/asteroid.obj.zip");
    ...
    private void createSphere() throws IOException {
        WavefrontMeshLoader loader = new WavefrontMeshLoader();
        sphere = loader.loadMesh("ui/game/sphere.obj.zip");
    }
    ...
    private void createCubemapProgram() throws IOException {
        int vshader = createShader("ui/game/cubemap.vs", GL_VERTEX_SHADER);
        int fshader = createShader("ui/game/cubemap.fs", GL_FRAGMENT_SHADER);
    ...
    private void createShipProgram() throws IOException {
        int vshader = createShader("ui/game/ship.vs", GL_VERTEX_SHADER);
        int fshader = createShader("ui/game/ship.fs", GL_FRAGMENT_SHADER);
        int program = createProgram(vshader, fshader);
        glUseProgram(program);
    ...
    private void createParticleProgram() throws IOException {
        int vshader = createShader("ui/game/particle.vs", GL_VERTEX_SHADER);
        int fshader = createShader("ui/game/particle.fs", GL_FRAGMENT_SHADER);
        int program = createProgram(vshader, fshader);
        glUseProgram(program);
    ...
    private void createShotProgram() throws IOException {
        int vshader = createShader("ui/game/shot.vs", GL_VERTEX_SHADER);
        int fshader = createShader("ui/game/shot.fs", GL_FRAGMENT_SHADER);
        int program = createProgram(vshader, fshader);
        glUseProgram(program);
    ...
    private void createCubemapTexture() throws IOException {
        ...
        for (int i = 0; i < 6; i++) {
            imageBuffer = ioResourceToByteBuffer("ui/game/space_" + names[i] + (i + 1) + ".jpg", 8 * 1024);
