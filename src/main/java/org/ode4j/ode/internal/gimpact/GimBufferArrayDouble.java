 ...
 */
public class GimBufferArrayDouble implements GimConstants { //formerly GBUFFER_ARRAY
...
//	};
    ...
    ObjArray<vec3f> GIM_BUFFER_ARRAY_POINTER(int _index) {
        return new ObjArray<vec3f>(m_buffer_data, _index * m_byte_stride);
    }
	...
	*/
    ...
    interface gim_kernel_func {
        void run(Object o, GimBufferArrayDouble b1, GimBufferArrayDouble b2);
    }
	...
	*/
    ...
    static void GIM_PROCESS_BUFFER_ARRAY(mat4f _uniform_data, GimBufferArrayDouble _src_array,
                                         GimBufferArrayDouble _dst_array,
...
//	    gim_buffer_free(m_buffer_id);
    ...
    public GimBufferArrayDouble cloneRefs() {
        GimBufferArrayDouble c = new GimBufferArrayDouble();
    ...
    public GimBufferArrayDouble cloneValues() {
        GimBufferArrayDouble c = new GimBufferArrayDouble();
    ...
    public static GimBufferArrayDouble createCopy(double[] array) {
        GimBufferArrayDouble c = new GimBufferArrayDouble();
    ...
    public static GimBufferArrayDouble createRef(double[] array) {
        //System.out.println("WARNING creating ref-copies of double[] is not supported.!");//TODO
        GimBufferArrayDouble c = new GimBufferArrayDouble();
        vec3f[] va = new vec3f[array.length / 3];
        for (int i = 0; i < va.length; i++) {
            vec3f v = new vec3f();
