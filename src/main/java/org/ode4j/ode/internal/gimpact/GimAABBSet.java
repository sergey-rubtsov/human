...
//	}
     ...
     * 20 give us a 0.05 doubleing point error
     */
    private static final double ERROR_AABB = 20.0f;
     ...
     */
    private static final double MAX_AABB_SIZE = 1638.0f; //TZ ??? TODO ??
    ...
    long GIM_CONVERT_VEC3F_GUINT_XZ(double vx, double vz) {
    ...
    long GIM_CONVERT_VEC3F_GUINT_XZ_UPPER(double vx, double vz) {
    ...
    long GIM_CONVERT_VEC3F_GUINT_XZ_CLAMPED(double vx, double vz) {
        ...
        //	    uint_key = (uint_key<<16) + _z;
        double _cx = CLAMP(vx, -MAX_AABB_SIZE, MAX_AABB_SIZE);
        double _cz = CLAMP(vz, -MAX_AABB_SIZE, MAX_AABB_SIZE);
    ...
    long GIM_CONVERT_VEC3F_GUINT_XZ_UPPER_CLAMPED(double vx, double vz) {
        //	    GREAL _cx = CLAMP(vx,-MAX_AABB_SIZE,MAX_AABB_SIZE);
        //	    GREAL _cz = CLAMP(vz,-MAX_AABB_SIZE,MAX_AABB_SIZE);
...
//		}
    ...
    void gim_aabbset_sort(final boolean calc_global_bound) {
        if (m_sorted_mincoords == null) {//allocate
...
//    };
    ...
    static void gim_aabbset_bipartite_intersections(GimAABBSet aabbset1,
        ...
        if (aabbset1.m_sorted_mincoords == null || aabbset2.m_sorted_mincoords == null) {//Brute force approach
...
//		System.out.println("IGNORED!");//TODO fix this!
    ...
    void gim_aabbset_ray_collision(vec3f vorigin, vec3f vdir, double tmax,
