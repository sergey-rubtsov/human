...
import org.ode4j.ode.internal.gimpact.GimBufferArrayDouble.GIM_PROCESS_BUFFER_ARRAY_FN;
...
import static org.ode4j.ode.internal.gimpact.GimGeometry.COMPUTEAABB_FOR_TRIANGLE;
import static org.ode4j.ode.internal.gimpact.GimGeometry.COPY_MATRIX_4X4;
import static org.ode4j.ode.internal.gimpact.GimGeometry.EDGE_PLANE;
import static org.ode4j.ode.internal.gimpact.GimGeometry.IDENTIFY_MATRIX_4X4;
import static org.ode4j.ode.internal.gimpact.GimGeometry.MAT_DOT_VEC_3X4;
import static org.ode4j.ode.internal.gimpact.GimGeometry.TRIANGLE_PLANE;
import static org.ode4j.ode.internal.gimpact.GimGeometry.VEC_COPY;
import static org.ode4j.ode.internal.gimpact.GimGeometry.VEC_COPY_4;
import static org.ode4j.ode.internal.gimpact.GimGeometry.mat4f;
import static org.ode4j.ode.internal.gimpact.GimGeometry.vec3f;
import static org.ode4j.ode.internal.gimpact.GimGeometry.vec4f;
...
public class GimTrimesh implements GimConstants {
    ...
    ///Original
    GimBufferArrayDouble m_source_vertex_buffer;//!< Buffer of vec3f coordinates
     ...
     * @invariant must be aligned
     */
    GimBufferArrayDouble m_transformed_vertex_buffer = new GimBufferArrayDouble();
...
//			GIM_TRIMESH * trimesh, GBUFFER_ARRAY * vertex_array, GBUFFER_ARRAY * triindex_array,char transformed_reply)
    static GimTrimesh gim_trimesh_create_from_arrays(
            GimBufferArrayDouble vertex_array,
        ...
        //GimBufferArrayDouble.gim_buffer_array_copy_ref(vertex_array,trimesh.m_source_vertex_buffer);
...
//	        GimBufferArrayDouble.gim_buffer_array_copy_value(vertex_array,
//				buffer_managers,trimesh.m_transformed_vertex_buffer,G_BUFFER_MANAGER.SYSTEM,G_MU_DYNAMIC_READ_WRITE);
            ...
            //GimBufferArrayDouble.gim_buffer_array_copy_ref(vertex_array,trimesh.m_transformed_vertex_buffer);
...
//			GUINT32 * triindex_array, GUINT32 index_count,char copy_indices,char transformed_reply)
    public static GimTrimesh gim_trimesh_create_from_data(
            double[] vertex_array, boolean copy_vertices,
            int[] triindex_array, boolean copy_indices, boolean transformed_reply) {
        GimTrimesh THIS;

        GimBufferArrayDouble buffer_vertex_array;// = new GimBufferArrayDouble();
        GimBufferArrayInt buffer_triindex_array;// = new GimBufferArrayInt();

        //Create vertices
        if (copy_vertices) {
//	        GimBufferArrayDouble.gim_create_common_buffer_from_data(buffer_managers,
//				new GPTR<vec3f[]>(vertex_array2), vertex_count,//*sizeof(vec3f), 
//				buffer_vertex_array.m_buffer_id);
            buffer_vertex_array = GimBufferArrayDouble.createCopy(vertex_array);
        } else//Create a shared buffer
        {
//	    	GimBufferArrayDouble.gim_create_shared_buffer_from_data(buffer_managers,
//				new GPTR<vec3f[]>(vertex_array2), vertex_count,//*sizeof(vec3f), 
//				buffer_vertex_array.m_buffer_id);
            buffer_vertex_array = GimBufferArrayDouble.createRef(vertex_array);
        }
...
//	        GimBufferArrayDouble.gim_buffer_array_copy_value(source_trimesh.m_source_vertex_buffer,
...
//	    return false;
	...
	*/
    ...
    void gim_trimesh_update_vertices() {
        ...
        //Vertices
        GimBufferArrayDouble psource_vertex_buffer = m_source_vertex_buffer;
        GimBufferArrayDouble ptransformed_vertex_buffer = m_transformed_vertex_buffer;
        //Temp transform
        mat4f transform = new mat4f();
        COPY_MATRIX_4X4(transform, m_transform);  //TODO TZ why copy?

        GimBufferArrayDouble.GIM_PROCESS_BUFFER_ARRAY(transform, psource_vertex_buffer, ptransformed_vertex_buffer,
...
//	        COMPUTEAABB_FOR_TRIANGLE((paabb[i]),v1,v2,v3);
	...
	*/
    ...
    public void gim_trimesh_set_tranform(mat4f transform) {
        double diff = 0.0f;
        double[] originaltrans = m_transform.f;//[0][0];
        double[] newtrans = transform.f;//[0][0];
        int i;
        for (i = 0; i < 16; i++) {
