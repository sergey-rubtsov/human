...
public class DxBVHSpace extends DxSpace implements DBhvSpace {
    ...
    @Override
    public void collide(final Object data, final DGeom.DNearCallback callback) {
        dAASSERT(callback);
    ...
    void collideGeomsNoAABBs(DxGeom g1, DxGeom g2, Object data, DGeom.DNearCallback callback) {
    ...
    @Override
    void collide2(final Object data, final DxGeom geom, final DGeom.DNearCallback callback) {
