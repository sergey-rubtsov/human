...
public final class DxStepperProcessingCallContext {
    ...
    int/*DxBody[]*/ GetSelectedIslandBodiesEnd() {
        return m_islandBodiesStartOfs + m_islandBodiesCount;
    }

    int/*DxJoint[]*/ GetSelectedIslandJointsEnd() {
        return m_islandJointsStartOfs + m_islandJointsCount;
    }
