...
public class GimpactDataPreprocessor {
    ...
    double[] buildAngles() {
        ...
        double[] angles = new double[numIndices];
    ...
    private double getAngle(int triangle, int vertexIndex, int neighbourTriangle) {
        ...
        double angle = Math.signum(tangent.dot(neighbourNormal));
