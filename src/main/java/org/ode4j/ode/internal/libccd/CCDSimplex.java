...
//		}
    ...
    static final ccd_support_t ccdSimplexLast(final ccd_simplex_t s) {
        ...
        switch (s.last) {
            case 0:
                return ccdSimplexPoint0(s);
            case 1:
                return ccdSimplexPoint1(s);
            case 2:
                return ccdSimplexPoint2(s);
            case 3:
                return ccdSimplexPoint3(s);
        }
...
//	}
    ...
    static final void ccdSimplexAdd(ccd_simplex_t s, final ccd_support_t v) {
        ...
        switch (s.last) {
            case 0:
                ccdSupportCopy(s.ps0, v);
                break;
            case 1:
                ccdSupportCopy(s.ps1, v);
                break;
            case 2:
                ccdSupportCopy(s.ps2, v);
                break;
            case 3:
                ccdSupportCopy(s.ps3, v);
                break;
            default:
                throw new IllegalArgumentException();
        }
