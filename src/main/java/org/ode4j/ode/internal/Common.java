...
//	}
    ...
    public static final double dRecip(double x) {
        return 1.0 / x;
    }
    ...
    public static final double dSqrt(double x) {
        return Math.sqrt(x);
    }
    ...
    public static final double dRecipSqrt(double x) {
    ...
    public static final double dSin(double x) {
        return Math.sin(x);
    }
    ...
    public static final double dCos(double x) {
        return Math.cos(x);
    }
    ...
    public static final double dFloor(double x) {
        return Math.floor(x);
    }

    //#define dCeil(x) ceilf(x)          /* ceil */
    public static final double dCeil(double x) {
        return Math.ceil(x);
    }
    ...
    //#define dIsNan(x) (_isnan(x))
    //#endif
    public final boolean dIsNan(double x) {
