...
public class DHumanJointImpl implements DHumanJoint {
    ...
    public DHumanJointImpl(JointType type, int bone, int bone2, DVector3 anchor, DVector3 axis, DVector3 axis2, double limitMin,
