...
import static deep.learning.human.internal.DrawStuff.DS_POLYFILL;
import static deep.learning.human.internal.DrawStuff.DS_TEXTURE_NUMBER;
import static deep.learning.human.internal.DrawStuff.DS_VERSION;
import static deep.learning.human.internal.DrawStuff.DS_WIREFRAME;
...
public class DrawStuffGL extends LwJGL implements DrawStuffApi {
    ...
    private static final boolean FOG = false;
...
//	}
    ...
    private static final FloatBuffer fog = BufferUtils.createFloatBuffer(4);
    ...
    static {
        ...
        fog.put(new float[]{0.5f, 0.5f, 0.5f, 1.0f}).flip();
    }
