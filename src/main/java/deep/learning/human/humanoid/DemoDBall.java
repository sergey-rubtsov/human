...
import static deep.learning.human.internal.DrawStuff.*;

public class DemoDBall extends DrawStuff.dsFunctions {
	...
	private void drawGeom(DGeom g)
	{
		...
		if (g instanceof DSphere) {
			...
			dsSetTexture (DrawStuff.DS_TEXTURE_NUMBER.DS_CHECKERED);
