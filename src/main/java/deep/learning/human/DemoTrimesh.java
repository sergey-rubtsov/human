...
import static deep.learning.human.internal.DrawStuff.dsDrawTriangle;
...
import static deep.learning.human.internal.DrawStuff.dsSetTexture;
...
/*
			float[] _planes = null;
			dsDrawConvex(Pos, Rot, _planes, 8, vertices, vertices.length, indices);*/
        for (int i = 0; i < indices.length; i += 3) {
            int p0 = indices[i + 0] * 3;
            int p1 = indices[i + 1] * 3;
            int p2 = indices[i + 2] * 3;
            dsDrawTriangle(Pos, Rot, vertices, p0, p1, p2, true);
        }
