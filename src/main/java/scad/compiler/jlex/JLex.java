/**************************************************************
 ...
 jlex.
 Generated jlex now accepts unicode LS (U+2028) and PS (U+2029) as
 ...
 action code blocks.
 Fixed input jlex to allow whitespace in character classes, closing
 ...
 The jlex can now be initialized with either an InputStream
 ...
 sequences.  Added try/catch block around jlex generation
 ...
 Made yychar, yyline, yytext global to the jlex so that
...
/******************************
 ...
 regular expressions
 18) clean up all of the class files the jlex
...
public class JLex {
    ...
    public static void main(String arg[]) throws java.io.IOException {
        ...
        if (arg.length < 1) {
            System.out.println("Usage: JLex <filename>");
            return;
        }
/*
    Note: For debug, it may be helpful to remove the try/catch block
